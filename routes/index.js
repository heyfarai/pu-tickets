...
exports = module.exports = function(app) {
	...
	app.all('/speakers', routes.views.speaker);
	app.all('/speakers/:speaker', routes.views.speaker);
	...
	app.all('/social', routes.views.social);
	app.all('/locations', routes.views.location);
